        ...
        <div className="col-12">
          ...
          <div className="box-order">
            <p className="form-group clearfix">
              Mã đơn hàng
              <span className="float-right"><strong>MSV1233141</strong></span>
            </p>
            <p><strong>Đơn hàng đang chuẩn bị</strong></p>
          ...
          <div className="box-order">
            <div className="box-progress form-group">
              <div className="box-step">
                ...
                <div className="is-stepinfo">
                  <p><strong>Đơn hàng đang lấy hàng</strong></p>
            ...
            <p>Địa chỉ: 12 Phạm Văn Đồng, phường 12, quận Gò Vấp, tp.Hồ Chí Minh </p>
          </div>
          <div className="box-order">
            ...
            <div className="table-responsive">
              <table className="table table-striped table-bordered table-hover">
                ...
                <tbody>
                  <tr>
                    <td><img alt="product" width="100" src="img/product.jpg"/></td>
                    <td>Rolex S1</td>
                    <td><span className="box-input"><i className="fas fa-square-full is_brown"></i></span></td>
                    <td>1</td>
                    <td><strong>720,000đ</strong></td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div className="box-order">
            <p className="form-group"><strong>Thời gian nhận hàng</strong></p>
            <div className="row">
          ...
          <p className="form-group text-center"><a className="btn btn-primary green" href="#test" role="button">Hủy đơn</a></p>
        </div>
      </div>
    )
}