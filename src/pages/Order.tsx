    ...
    <div className="col-12">
      ...
      <div className="box-order">
        <p className="form-group clearfix">
          ...
          <span className="float-right"><a href="#">Thay đổi</a></span>
        </p>
        <p>Lê Lý </p>
      ...
      <div className="box-order">
        ...
        <div className="table-responsive">
          <table className="table table-striped table-bordered table-hover">
            ...
            <tbody>
              <tr>
                <td><img alt="product" width="100" src={`${process.env.PUBLIC_URL}/${product?.img}`} /></td>
                <td>{product?.name}</td>
                <td><span className="box-input"><i className="fas fa-square-full is_brown"></i></span></td>
                <td>1</td>
                <td><strong>{product?.price.toLocaleString('vi-VN')}đ</strong></td>
              </tr>
            </tbody>
          </table>
        </div>
